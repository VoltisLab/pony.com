  ...
  return (
    <div className="w-full lg:flex lg:mb-[1vw] 2xl:mb-[0.6vw] relative">
      ...
      <div
        ...
        className="flex items-center justify-between py-2.5 px-2 w-full md:max-w-[90%] border border-[#9E9E9E] rounded-full text-white cursor-pointer hover:border-gray-400 transition-colors"
      >
