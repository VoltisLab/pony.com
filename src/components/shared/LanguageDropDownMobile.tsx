  ...
  return (
    <div className="w-full lg:flex lg:mb-[1vw] 2xl:mb-[0.6vw] relative mt-4">
      ...
      <div
        ...
        className="flex items-center justify-between py-2.5 px-2 w-full  border border-[#9E9E9E] rounded-full text-white cursor-pointer hover:border-gray-400 transition-colors"
      >
