          ...
          >
            <div className="relative w-full rounded-none lg:rounded-[1.25vw] overflow-hidden group">
              ...
              <div className="absolute inset-0 flex items-end mb-5 lg:mb-[1.042vw]">
                <motion.div
                  className="pl-5 pr-4 lg:pl-[1.042vw] lg:pr-[1.667vw] max-w-md lg:max-w-[26.667vw] xl:max-w-[30vw]"
                ...
                >
                  <motion.h2
                    className="text-lg lg:text-[1.563vw] xl:text-[1.875vw] 2xl:text-[2.5vw] font-black text-white leading-[1.1] mb-4 lg:mb-[1.042vw]"
                  ...
                  <motion.p
                    className="text-white text-[10px] lg:text-[0.938vw] md:font-semibold leading-relaxed lg:leading-relaxed max-w-sm lg:max-w-[20vw]"
