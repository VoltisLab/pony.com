...
const VibeSection: React.FC<VibeSectionProps> = ({
  ...
  return (
    <section className="bg-black text-white py-12 overflow-hidden">
      <div className="w-full mx-auto px-5 md:px-16 lg:px-[4vw]">
        <motion.div
          className="flex flex-col lg:flex-row items-center gap-2 sm:gap-12 md:gap-16 lg:gap-[6vw]"
          initial={{ opacity: 0 }}
        ...
        >
          ...
          >
            <div className="w-full flex flex-col items-center lg:items-start">
              ...
              <motion.p
                className="text-[11px] sm:text-lg md:text-xl lg:text-[1.35vw] lg:mb-[1.4vw] text-white leading-relaxed"
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="flex gap-2 lg:gap-[0vw]">
              <motion.div
                className="relative flex-1 min-w-0 h-48 md:h-64 lg:h-[22vw] rounded-xl sm:rounded-2xl overflow-hidden"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.6 }}
                viewport={{ once: true }}
              ...
              >
                <Image
                  ...
                  priority
                />
                <div className="absolute bottom-0 left-0 right-0 h-16 lg:h-[3vw] bg-gradient-to-t from-black/90 to-transparent" />
              </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-white text-sm sm:text-xl md:text-2xl lg:text-[1.8vw] font-sfpro text-center leading-[160%] font-medium px-4 sm:px-6 py-0 sm:py-4">
                {subtitle}
              </p>
            </motion.div>
          </motion.div>
